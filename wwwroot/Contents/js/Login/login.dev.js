...
$(document).ready(function () {
    ...
    $("#forgot-password-bytax").click(function () {
        $('#forgotpass').fadeOut();
        $('#submit-forgotpass-bytax, #submit-forgotpass-bytax form').fadeIn();
    })

    // Close Popup
    $(document).on("click", ".box-button .btn-close, .bgsend-overlay, .close-connection", function (e) {
        e.preventDefault();
        HideAllPopup();
    });
    //#endregion
...
function SubmitLogin() {
    ...
    data.push({ name: 'Captcha', value: $('#frmLogin #g-recaptcha-response-2').val() });
    $.ajax({
...
function ForgotPassword() {
    ...
    data.push({ name: 'Captcha', value: $('.show-forgotpass #g-recaptcha-response-1').val() });
    $.ajax({
...
function SubmitForgotPasswordByTax() {
    ...
    $.ajax({
        ...
        success: function (res) {
            HidePreloader();
            if (res !== null && res.code === 200) {
                $("#submit-forgotpass-bytax form").fadeOut();
                $("#submit-forgotpass-bytax .popup-successtax").fadeIn();
            } else {
